...
describe('the IndVar Container', function () {
  ...
  xit('should call setActionsPerTrial on actionsPerTrial change', function () {
  ...
  xit('should call setNumTrials on numTrials change', function () {
  ...
  xit('should call setRandomized on randomized change', function () {
  ...
  xit('should call pushOption on click', function () {
  ...
  xit('should call popOption on click', function () {
